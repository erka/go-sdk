...
func hydratedMocksForClientTests(t *testing.T, expectedEvaluations int) clientMocks {
	...
	mockEvaluationAPI.EXPECT().ForEvaluation(gomock.Any()).Times(expectedEvaluations).DoAndReturn(func(_ string) (*MockProvider, []Hook, EvaluationContext) {
...
func TestRequirement_1_4_2__1_4_5__1_4_6(t *testing.T) {
	...
	t.Run("BooleanValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.BooleanValueDetails(t.Context(), flagKey, false, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
	...
	t.Run("StringValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.StringValueDetails(t.Context(), flagKey, "", EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
	...
	t.Run("FloatValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.FloatValueDetails(t.Context(), flagKey, 0, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
	...
	t.Run("IntValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.IntValueDetails(t.Context(), flagKey, 0, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
	...
	t.Run("ObjectValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.ObjectValueDetails(t.Context(), flagKey, defaultValue, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
...
func TestRequirement_1_4_4(t *testing.T) {
	...
	t.Run("BooleanValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.BooleanValueDetails(t.Context(), flagKey, true, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
	...
	t.Run("FloatValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.FloatValueDetails(t.Context(), flagKey, 1, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
		if evDetails.FlagKey != flagKey {
	...
	t.Run("IntValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.IntValueDetails(t.Context(), flagKey, 1, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
		if evDetails.FlagKey != flagKey {
	...
	t.Run("ObjectValueDetails", func(t *testing.T) {
		...
		evDetails, err := client.ObjectValueDetails(t.Context(), flagKey, 1, EvaluationContext{})
		if err != nil {
			t.Error(err)
		}
		if evDetails.FlagKey != flagKey {
...
func TestRequirement_1_4_9(t *testing.T) {
	...
	t.Run("Boolean", func(t *testing.T) {
		...
		value := client.Boolean(t.Context(), flagKey, defaultValue, evalCtx)

		if value != defaultValue {
			t.Errorf("expected default value from BooleanValue, got %v", value)
		}

		valueDetails, err := client.BooleanValueDetails(t.Context(), flagKey, defaultValue, evalCtx)
		if err == nil {
	...
	t.Run("String", func(t *testing.T) {
		...
		value := client.String(t.Context(), flagKey, defaultValue, evalCtx)

		if value != defaultValue {
			t.Errorf("expected default value from StringValue, got %v", value)
		}

		valueDetails, err := client.StringValueDetails(t.Context(), flagKey, defaultValue, evalCtx)
		if err == nil {
	...
	t.Run("Float", func(t *testing.T) {
		...
		value := client.Float(t.Context(), flagKey, defaultValue, evalCtx)

		if value != defaultValue {
			t.Errorf("expected default value from FloatValue, got %v", value)
		}

		valueDetails, err := client.FloatValueDetails(t.Context(), flagKey, defaultValue, evalCtx)
		if err == nil {
	...
	t.Run("Int", func(t *testing.T) {
		...
		value := client.Int(t.Context(), flagKey, defaultValue, evalCtx)

		if value != defaultValue {
			t.Errorf("expected default value from IntValue, got %v", value)
		}

		valueDetails, err := client.IntValueDetails(t.Context(), flagKey, defaultValue, evalCtx)
		if err == nil {
			t.Error("expected FloatValueDetails to return an error, got nil")
		}
	...
	t.Run("Object", func(t *testing.T) {
		...
		value := client.Object(t.Context(), flagKey, defaultValue, evalCtx)

		if value != defaultValue {
			t.Errorf("expected default value from ObjectValue, got %v", value)
		}

		valueDetails, err := client.ObjectValueDetails(t.Context(), flagKey, defaultValue, evalCtx)
		if err == nil {
...
func TestTrack(t *testing.T) {
	...
	type testcase struct {
		...
		provider func(tc *testcase, provider *MockProvider) FeatureProvider
	}
	...
	tests := map[string]*testcase{
		"merging in correct order": {
			...
			provider: func(tc *testcase, mockProvider *MockProvider) FeatureProvider {
...
func TestBeforeHookNilContext(t *testing.T) {
	...
	_ = client.Boolean(t.Context(), "foo", false, evalCtx, WithHooks(hookNilContext))
}
...
func TestObjectEvaluationShouldSupportNilValue(t *testing.T) {
	...
	evDetails, err := client.ObjectValueDetails(t.Context(), "foo", nil, EvaluationContext{})
	if err != nil {
...
func TestRequirement_1_7_6(t *testing.T) {
	...
	defaultVal := true
	res := client.Boolean(t.Context(), "a-flag", defaultVal, EvaluationContext{})
