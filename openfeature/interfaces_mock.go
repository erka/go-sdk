...
// Source: go.openfeature.dev/openfeature (interfaces: clientEvent,evaluationImpl,Hook,FeatureProvider,StateHandler,Tracker)
//
...
func (m *MockHook) After(ctx context.Context, hookContext HookContext, flagEvaluationDetails EvaluationDetails[FlagTypes], hookHints HookHints) error {
	m.ctrl.T.Helper()
...
func (m *MockHook) Before(ctx context.Context, hookContext HookContext, hookHints HookHints) (context.Context, *EvaluationContext, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Before", ctx, hookContext, hookHints)
	ret0, _ := ret[0].(context.Context)
	ret1, _ := ret[1].(*EvaluationContext)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockHook) Finally(ctx context.Context, hookContext HookContext, flagEvaluationDetails EvaluationDetails[FlagTypes], hookHints HookHints) {
	m.ctrl.T.Helper()
...
func (m *MockStateHandler) Init(ctx context.Context, evaluationContext EvaluationContext) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Init", ctx, evaluationContext)
	ret0, _ := ret[0].(error)
	return ret0
}

// Init indicates an expected call of Init.
func (mr *MockStateHandlerMockRecorder) Init(ctx, evaluationContext any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Init", reflect.TypeOf((*MockStateHandler)(nil).Init), ctx, evaluationContext)
}

// Shutdown mocks base method.
func (m *MockStateHandler) Shutdown(ctx context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Shutdown", ctx)
	ret0, _ := ret[0].(error)
	return ret0
...
// Shutdown indicates an expected call of Shutdown.
func (mr *MockStateHandlerMockRecorder) Shutdown(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Shutdown", reflect.TypeOf((*MockStateHandler)(nil).Shutdown), ctx)
}
