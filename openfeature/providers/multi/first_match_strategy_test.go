...
func configureFirstMatchProviderMock[R of.FlagTypes](mock *of.MockProvider, value R, error int, providerName string) {
	...
	default:
		mock.EXPECT().
			...
			Return(of.ObjectResolutionDetail{Value: v, ProviderResolutionDetail: details})
	}
