...
type (
	...
	ResolutionIterator[T of.FlagTypes] = iter.Seq2[string, *of.GenericResolutionDetail[T]]

	// FallbackEvaluator evaluates the fallback provider when the strategy needs it.
	FallbackEvaluator[T of.FlagTypes] = func(fallbackProvider of.FeatureProvider) *of.GenericResolutionDetail[T]
	...
	StrategyFn[T of.FlagTypes] func(resolutions ResolutionIterator[T], defaultValue T, fallbackEvaluator FallbackEvaluator[T]) *of.GenericResolutionDetail[T]
	...
	StrategyConstructor func() StrategyFn[of.FlagTypes]
	...
	evaluationFn[T of.FlagTypes] func(ctx context.Context, flag string, defaultValue T, flatCtx of.FlattenedContext) *of.GenericResolutionDetail[T]
)
...
func evaluate[T of.FlagTypes](ctx context.Context, provider of.FeatureProvider, registeredName string, flag string, defaultVal T, flatCtx of.FlattenedContext) *of.GenericResolutionDetail[T] {
